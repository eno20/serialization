...
public class Person2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3721749516377840480L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Person2\",\"namespace\":\"com.uangel.marshal.avro.test\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"}]}");
   ...
   */
  public Person2(java.lang.CharSequence name, java.lang.CharSequence email) {
    this.name = name;
    this.email = email;
  }
   ...
   */
  public static com.uangel.marshal.avro.test.Person2.Builder newBuilder() {
    return new com.uangel.marshal.avro.test.Person2.Builder();
  }
   ...
   * @return A new Person2 RecordBuilder
   */
  public static com.uangel.marshal.avro.test.Person2.Builder newBuilder(com.uangel.marshal.avro.test.Person2.Builder other) {
    return new com.uangel.marshal.avro.test.Person2.Builder(other);
  }
   ...
   * @return A new Person2 RecordBuilder
   */
  public static com.uangel.marshal.avro.test.Person2.Builder newBuilder(com.uangel.marshal.avro.test.Person2 other) {
    return new com.uangel.marshal.avro.test.Person2.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Person2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.uangel.marshal.avro.test.Person2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.uangel.marshal.avro.test.Person2 other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uangel.marshal.avro.test.Person2.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uangel.marshal.avro.test.Person2.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uangel.marshal.avro.test.Person2.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.uangel.marshal.avro.test.Person2.Builder clearEmail() {
      email = null;
